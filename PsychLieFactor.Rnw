...
\includegraphics[width=\linewidth]{images/Necker_cube.png}
\caption{The original Necker cube}
\end{subfigure}
\begin{subfigure}[b]{.3\linewidth}\centering
\includegraphics[width=\linewidth]{images/Necker_cube1.png}
\caption{Interpretation 1}
\end{subfigure}
\begin{subfigure}[b]{.3\linewidth}\centering
\includegraphics[width=\linewidth]{images/Necker_cube2.png}
