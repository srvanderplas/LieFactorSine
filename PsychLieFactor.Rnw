...
\hline
\end{tabular}
\caption{Credible intervals for the overall $theta$ for exponential, inverse, and sine stimuli.}\label{credibleintervalstheta}\end{table}
