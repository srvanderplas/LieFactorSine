...
library(ggplot2)
correct.x <- function(x, y, data, f, fprime, f2prime=NULL, weight=NULL, ratio=1){ 
...
correct.y <- function(x, y, data, f, fprime, f2prime=NULL, weight=NULL, ratio=1){
...
correct <- function(x, y, data, type, f, fprime, f2prime=NULL, weight=NULL, ratio=1){
  if(type=="x") correct.x(x, y, data, f, fprime, f2prime=NULL, weight, ratio)
  else correct.y(x, y, data, f, fprime, f2prime=NULL, weight, ratio)
}
