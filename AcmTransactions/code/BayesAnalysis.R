...
# })
# 
# # test.post.indiv$functions <- c("Sine", "Exponential", "Inverse")[as.numeric(test.post.indiv$test_param)]
# test.post.indiv$functions <- factor(test.post.indiv$test_param, levels=c("Sin", "Exp", "Inv"), labels=c("Sine", "Exponential", "Inverse"))
# # overall.mean.bounds$functions <- c("Exponential", "Inverse", "Sine")[as.numeric(factor(overall.mean.bounds$test_param))]
# overall.mean.bounds$functions <- factor(overall.mean.bounds$test_param, levels=c("Sin", "Exp", "Inv"), labels=c("Sine", "Exponential", "Inverse"))
# 
...
# test.mean.marginal$functions <- factor(test.mean.marginal$test_param, levels=c("Sin", "Exp", "Inv"), labels=c("Sine", "Exponential", "Inverse"))
