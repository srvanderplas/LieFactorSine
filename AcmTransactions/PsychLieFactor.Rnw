...
\begin{figure}\centering
\includegraphics[width=6in]{figure/fig-spaghettiIndivDists}
...
\begin{figure}\centering
\includegraphics[width=6in]{figure/fig-IndivMeanAllFcns}
...
\begin{figure}\centering
\includegraphics[width=6in]{figure/fig-CIindivMean}
