...
\]
where $w$ is varied between 0 (for no correction) and 1.5 (strong over-correction). From a pilot study, we suspected values around $w = 0.8$ to be promising, but did not know whether this would generalize to those outside of the statistical graphics community. This led to twelve stimuli sets with correction factors as shown in table~\ref{tab:w}. The difficulty level of each of the twelve stimuli sets was determined by the similarity of the six plots shown.

\begin{figure}
\centering
\includegraphics[width=6in]{figure/fig-stimulicorrectionsize1}
\caption{One of the graphs presented to participants through Amazon Mechanical Turk. Figure \ref{fig:sinestimulinotrend} shows the actual differences in line lengths.}\label{fig:sinestimuli}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=6in, trim=0in .15in 0in .15in]{images/fig-stimulicorrectionsize2}
\caption{Line lengths (without the trend) for figure~\ref{fig:sinestimuli}, demonstrating the effective lie factor for each sub-plot.}\label{fig:sinestimulinotrend}
\end{figure}
% latex table generated in R 2.15.1 by xtable 1.7-0 package
% Sun Mar 31 12:08:30 2013
\begin{table}[ht]
\centering
\tbl{\label{tab:w} Ordered weight factors and corresponding line factors for the sine curve stimuli sets.}{
